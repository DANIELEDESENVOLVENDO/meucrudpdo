...
<!----Configuração painel fornecedor---->
<!DOCTYPE html>
<html>
<head>
...
if(isset($_POST['salvar'])){
	...
	$produto = $_POST['produto'];
		...
		//VERIFICAR SE O EMAIL DO FORNECEDOR JÁ ESTÁ CADASTRADO, com select de Query para resultado de pesquisa de e-mail,
		//e método prepare, pois não teremos os valores de referências que serão inseridos
...
<!----O que é query no PHP?
Uma query é um pedido de uma informação ou de um dado. Esse pedido também pode
